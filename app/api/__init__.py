...
blueprint.add_url_rule('/auth/user/list', endpoint='auth_user_list', view_func=get_user_list, methods=['GET', 'POST'])
blueprint.add_url_rule('/auth/user/detail/<username>', endpoint='auth_get_user_detail', view_func=get_user_detail, methods=['GET'])
blueprint.add_url_rule('/auth/user/profile', endpoint='auth_get_user_profile', view_func=get_user_profile, methods=['GET'])
blueprint.add_url_rule('/auth/user/profile', endpoint='auth_update_user_profile', view_func=update_user_profile, methods=['PUT'])
